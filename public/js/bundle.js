...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"config.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.nisIconSrc = exports.nisIconAlt = exports.mobileNisIconSrc = exports.mobileEuroIconSrc = exports.heIconSrc = exports.heIconAlt = exports.euroIconSrc = exports.euroIconAlt = exports.enIconSrc = exports.enIconAlt = exports.baseProdUrl = exports.baseDevUrl = exports.assetFavoriteIconOutlineSrc = exports.assetFavoriteIconFullSrc = exports.TYPE_KEY = exports.SORT_KEY = exports.RES_PER_PAGE_KEY = exports.PAGE_NUMBER_KEY = exports.NIS_CURRENCY = exports.LANGUAGE_KEY = exports.FILTER_KEY = exports.FAVORITE_KEY = exports.Elements = exports.EN_LANGUAGE = exports.DEFAULT_TYPE = exports.DEFAULT_SORT = exports.DEFAULT_RES_PER_PAGE = exports.DEFAULT_PAGE_NUM = exports.DEFAULT_LANGUAGE = exports.DEFAULT_FILTER = exports.DEFAULT_CURRENCY = exports.DEFAULT_BLOG_RES_PER_PAGE = exports.CURRENCY_KEY = void 0;
...
var baseDevUrl = exports.baseDevUrl = 'http://127.0.0.1:8000/';
var baseProdUrl = exports.baseProdUrl = 'https://www.dirabulgarit.com/';
var euroIconSrc = exports.euroIconSrc = '/img/icons/euro.svg';
var mobileEuroIconSrc = exports.mobileEuroIconSrc = '/img/icons/euro-white.svg';
var euroIconAlt = exports.euroIconAlt = 'אייקון של מטבע היורו';
var nisIconSrc = exports.nisIconSrc = '/img/icons/nis.svg';
var mobileNisIconSrc = exports.mobileNisIconSrc = '/img/icons/nis-white.svg';
var nisIconAlt = exports.nisIconAlt = 'אייקון של מטבע השקל';
var CURRENCY_KEY = exports.CURRENCY_KEY = 'currency';
var DEFAULT_CURRENCY = exports.DEFAULT_CURRENCY = 'euro';
var NIS_CURRENCY = exports.NIS_CURRENCY = 'nis';
var heIconSrc = exports.heIconSrc = '/img/icons/flag-for-flag-israel-svgrepo-com.svg';
var heIconAlt = exports.heIconAlt = 'אייקון של דגל ישראל';
var enIconSrc = exports.enIconSrc = '/img/icons/flag-for-flag-united-states-svgrepo-com.svg';
var enIconAlt = exports.enIconAlt = 'אייקון של דגל ארצות הברית';
var LANGUAGE_KEY = exports.LANGUAGE_KEY = 'language';
var DEFAULT_LANGUAGE = exports.DEFAULT_LANGUAGE = 'he';
var EN_LANGUAGE = exports.EN_LANGUAGE = 'en';
var FAVORITE_KEY = exports.FAVORITE_KEY = 'favorite';
var assetFavoriteIconOutlineSrc = exports.assetFavoriteIconOutlineSrc = '/img/icons/heart-empty-svgrepo-com-outline.svg';
var assetFavoriteIconFullSrc = exports.assetFavoriteIconFullSrc = '/img/icons/heart-svgrepo-com-full.svg';
var SORT_KEY = exports.SORT_KEY = 'sort';
var TYPE_KEY = exports.TYPE_KEY = 'type';
var PAGE_NUMBER_KEY = exports.PAGE_NUMBER_KEY = 'pageNumber';
var RES_PER_PAGE_KEY = exports.RES_PER_PAGE_KEY = 'resPerPage';
var FILTER_KEY = exports.FILTER_KEY = 'filter';
var DEFAULT_SORT = exports.DEFAULT_SORT = 'price';
var DEFAULT_TYPE = exports.DEFAULT_TYPE = 1;
var DEFAULT_PAGE_NUM = exports.DEFAULT_PAGE_NUM = 1;
var DEFAULT_RES_PER_PAGE = exports.DEFAULT_RES_PER_PAGE = 16;
var DEFAULT_BLOG_RES_PER_PAGE = exports.DEFAULT_BLOG_RES_PER_PAGE = 10;
var DEFAULT_FILTER = exports.DEFAULT_FILTER = {};
},{}],"asset.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.filterAssets = void 0;
...
var filterAssets = exports.filterAssets = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(filter, sort, type, pageNumber, resPerPage) {
    var urlParams, res, totalAssets, totalPages, _pageNumber;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlParams = "".concat(sort, "/").concat(type, "/").concat(pageNumber, "/").concat(resPerPage);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "/asset/search/".concat(urlParams),
            data: {
              filter: filter
            }
          });
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            _pageNumber = res.data.data.pageNumber;
            window.location.href = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? "/asset/search-results?sort=".concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber) : "".concat(config.baseProdUrl).concat(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), "/asset/search-results?sort=").concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber);
          }
          _context.next = 11;
          break;
        case 8:
  ...
  return function filterAssets(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./config":"config.js"}],"blog.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var getBlogs = exports.getBlogs = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(pageNumber, resPerPage) {
    var urlParams, res, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlParams = "".concat(pageNumber, "/").concat(resPerPage);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "/blog/get-blogs/".concat(urlParams)
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            ...
            window.location.href = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? "/blog" : "".concat(config.baseProdUrl).concat(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), "/blog");
          }
          _context.next = 11;
          break;
        case 8:
...
},{"axios":"../../node_modules/axios/index.js","./config":"config.js"}],"favoriteAssets.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getFavoriteAssets = void 0;
var _axios = _interopRequireDefault(require("axios"));
var config = _interopRequireWildcard(require("./config"));
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var getFavoriteAssets = exports.getFavoriteAssets = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(favoriteAssets) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            window.location.href = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? '/asset/favorite-assets' : '/en/asset/favorite-assets';
          }
          _context.next = 10;
          break;
        case 7:
  ...
  return function getFavoriteAssets(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./config":"config.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(long, lat, title) {
  ...
  if (long && lat) {
    ...
    var map = L.mapbox.map('map').setView([lat, long], 15).addLayer(L.mapbox.styleLayer('mapbox://styles/mapbox/streets-v12'));
    var myLayer = L.mapbox.featureLayer().addTo(map);
    myLayer.setGeoJSON(geojson);
  }
};
},{}],"language.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.switchLang = exports.loadLang = void 0;
var _axios = _interopRequireDefault(require("axios"));
var config = _interopRequireWildcard(require("./config"));
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var switchLang = exports.switchLang = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(language, href) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            if (href.includes("".concat(config.baseProdUrl, "asset/search-results")) || href.includes("".concat(config.baseProdUrl).concat(config.EN_LANGUAGE, "/asset/search-results"))) {
              (0, _asset.filterAssets)(JSON.parse(localStorage.getItem(config.FILTER_KEY)), JSON.parse(localStorage.getItem(config.SORT_KEY)), JSON.parse(localStorage.getItem(config.TYPE_KEY)), JSON.parse(localStorage.getItem(config.PAGE_NUMBER_KEY)), JSON.parse(localStorage.getItem(config.RES_PER_PAGE_KEY)));
            } else if (href === "".concat(config.baseProdUrl, "blog") || href === "".concat(config.baseProdUrl).concat(config.EN_LANGUAGE, "/blog")) {
              (0, _blog.getBlogs)(JSON.parse(localStorage.getItem(config.PAGE_NUMBER_KEY)), JSON.parse(localStorage.getItem(config.RES_PER_PAGE_KEY)));
            } else {
  ...
  return function switchLang(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var loadLang = exports.loadLang = /*#__PURE__*/function () {
  ...
  return function loadLang(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./config":"config.js","./asset":"asset.js","./blog":"blog.js"}],"pdf.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var generatePDF = exports.generatePDF = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(pdfData) {
    var res, pdfUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
},{"axios":"../../node_modules/axios/index.js","./config":"config.js"}],"alerts.js":[function(require,module,exports) {
"use strict";
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('.webinar-contact-us-top-container').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000);
};
},{"./config":"config.js"}],"webinar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.webinarRegistration = void 0;
var _axios = _interopRequireDefault(require("axios"));
var config = _interopRequireWildcard(require("./config"));
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var webinarRegistration = exports.webinarRegistration = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userName, userPhone, userEmail, userIsSubscribed) {
    var urlParams, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlParams = "".concat(userName, "/").concat(userPhone, "/").concat(userEmail, "/").concat(userIsSubscribed);
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "/user/webinar-registration/".concat(urlParams)
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            window.location.href = "".concat(config.baseProdUrl, "user/webinar-registered");
          }
          _context.next = 11;
          break;
        case 8:
  ...
  return function webinarRegistration(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./config":"config.js","./alerts":"alerts.js"}],"utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.switchSearchPriceCurrencyHtmlOnLoad = exports.switchLanguageIconsSrc = exports.switchLanguage = exports.switchCurrencyIconsSrc = exports.switchCurrency = exports.switchAssetPriceCurrency = exports.reverseString = exports.removeFromFavorite = exports.priceInputSetter = exports.modifyUrl = exports.getPageBySlug = exports.getFormData = exports.ddBtnTextSetter = exports.clearSearchChoices = exports.clearDuplicates = exports.checkIfFavorite = exports.btnAddActive = exports.addToFavorite = exports.addNavigator = void 0;
var config = _interopRequireWildcard(require("./config"));
...
var switchSearchPriceCurrencyHtmlOnLoad = exports.switchSearchPriceCurrencyHtmlOnLoad = function switchSearchPriceCurrencyHtmlOnLoad(priceInput) {
  var isEuro = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  if (isEuro) {
    if (priceInput) priceInput.forEach(function (el) {
...
var switchCurrencyIconsSrc = exports.switchCurrencyIconsSrc = function switchCurrencyIconsSrc() {
  var isEuro = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  if (isEuro) {
...
var switchSearchPriceCurrencyHtml = function switchSearchPriceCurrencyHtml(ddBtn, priceInput) {
  var isEuro = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  if (isEuro) {
...
var switchAssetPriceCurrency = exports.switchAssetPriceCurrency = function switchAssetPriceCurrency() {
  var currencySymbol = JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪';
  if (config.Elements.assetPrice) config.Elements.assetPrice.forEach(function (el) {
    if (currencySymbol === '₪') {
...
var switchCurrency = exports.switchCurrency = function switchCurrency(currencyIconSrc) {
...
var switchLanguageIconsSrc = exports.switchLanguageIconsSrc = function switchLanguageIconsSrc() {
  var isHebrew = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  if (isHebrew) {
...
var modifyUrl = exports.modifyUrl = function modifyUrl(inputStr, part) {
  ...
  function removeEn(str, part) {
    var partIndex = str.indexOf(part);
    if (partIndex === -1) return str;
    var enIndex = str.indexOf('en', partIndex + part.length);
...
var switchLanguage = exports.switchLanguage = function switchLanguage(langIconSrc, href) {
  if (langIconSrc.includes(config.heIconSrc)) {
    ...
    (0, _language.switchLang)(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), href);
  } else {
...
var reverseString = exports.reverseString = function reverseString(s) {
  return s.split('').reverse().join('');
};
var getFormData = exports.getFormData = function getFormData(cityFilter, roomsFilter, oceanViewFilter, projectFilter, currency, priceMinInput, priceMaxInput, idInput, nameInput) {
  var searchFilterObj = {
    city: [],
    rooms: [],
    oceanView: [],
...
var emptyFilterObj = function emptyFilterObj(filterObj) {
  filterObj = {
    city: [],
    rooms: [],
    project: [],
...
var emptyFilterObjBesideProjects = function emptyFilterObjBesideProjects(filterObj) {
  var emptyFilterObj = {
    city: [],
    rooms: [],
    project: [],
...
var btnAddActive = exports.btnAddActive = function btnAddActive(searchFilterObj, filterBtn, type) {
  var notModal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  var ddBtn = arguments.length > 4 ? arguments[4] : undefined;
  filterBtn.forEach(function (el) {
    if (type === 'city') {
      var _iterator = _createForOfIteratorHelper(searchFilterObj.city),
        _step;
      try {
    ...
    if (type === 'oceanView') {
      var _iterator2 = _createForOfIteratorHelper(searchFilterObj.oceanView),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var oceanView = _step2.value;
    ...
    if (type === 'rooms') {
      var _iterator3 = _createForOfIteratorHelper(searchFilterObj.rooms),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var rooms = _step3.value;
    ...
    if (type === 'project') {
      var _iterator4 = _createForOfIteratorHelper(searchFilterObj.project),
        _step4;
      try {
...
var ddBtnTextSetter = exports.ddBtnTextSetter = function ddBtnTextSetter(ddBtn, filterBtn) {
...
var priceInputSetter = exports.priceInputSetter = function priceInputSetter(inputMin, inputMax) {
  var onLoad = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var notModal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  var ddBtn = arguments.length > 4 ? arguments[4] : undefined;
  var currencySymbol = JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪';
  if (!onLoad) {
    document.querySelector('.content-col').addEventListener('click', function (e) {
      ...
      if (inputMin.value && inputMax.value) {
        ...
        if (notModal) {
          var priceText = document.createTextNode(' (' + inputMin.value + ' - ' + inputMax.value + ')');
          ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
        ...
        inputMax.value = currencySymbol + inputMax.value;
        if (notModal) {
          var _priceText = document.createTextNode(' (' + (inputMin.value = inputMin.placeholder) + ' - ' + inputMax.value + ')');
          ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
          ddBtn.appendChild(_priceText);
        }
      } else if (inputMin.value && !inputMax.value) {
        inputMin.value = currencySymbol + inputMin.value;
        if (notModal) {
          var _priceText2 = document.createTextNode(' (' + inputMin.value + ' - ' + (inputMax.value = inputMax.placeholder) + ')');
          ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
          ddBtn.appendChild(_priceText2);
        }
      } else if (!inputMin.value && !inputMax.value) {
        if (notModal) {
          var _priceText3 = document.createTextNode(' (' + currencySymbol + '0' + ' - ' + currencySymbol + '10,000,000' + ')');
          ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
          ddBtn.appendChild(_priceText3);
        }
      }
    });
  } else {
    ...
    if (inputMin.value && inputMax.value) {
      ...
      inputMax.value = currencySymbol + inputMax.value;
      if (notModal) {
        var _priceText4 = document.createTextNode(' (' + (inputMin.value = inputMin.placeholder) + ' - ' + inputMax.value + ')');
        ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
        ddBtn.appendChild(_priceText4);
      }
    } else if (inputMin.value && !inputMax.value) {
      inputMin.value = currencySymbol + inputMin.value;
      if (notModal) {
        var _priceText5 = document.createTextNode(' (' + inputMin.value + ' - ' + (inputMax.value = inputMax.placeholder) + ')');
        ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
        ddBtn.appendChild(_priceText5);
      }
    } else if (!inputMin.value && !inputMax.value) {
      if (notModal) {
        var _priceText6 = document.createTextNode(' (' + currencySymbol + '0' + ' - ' + currencySymbol + '10,000,000' + ')');
        ddBtn.innerText = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? ddBtn.dataset.he : ddBtn.dataset.en;
        ddBtn.appendChild(_priceText6);
      }
    }
  }
};
var clearSearchChoices = exports.clearSearchChoices = function clearSearchChoices(searchFilterObj, ddBtn, filterBtn, input) {
  var emptySearchFilterObj = {
    city: [],
    rooms: [],
    project: [],
    oceanView: [],
  ...
  ddBtn.forEach(function (el) {
    if (!el.innerText.includes('מחיר') || !el.innerText.includes('price')) {
      ...
      el.innerText = el.dataset.he + " (".concat(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪', "0 - ").concat(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪', "1,000,000)");
    }
  });
  filterBtn.forEach(function (el) {
...
var clearDuplicates = exports.clearDuplicates = function clearDuplicates(searchFilterObj) {
  var filterSet = new Set();
  searchFilterObj.oceanView.forEach(function (el) {
    return filterSet.add(el);
  });
  searchFilterObj.oceanView = [];
  var _iterator5 = _createForOfIteratorHelper(filterSet),
    _step5;
  try {
...
var getPageBySlug = exports.getPageBySlug = function getPageBySlug(elementArray, page) {
  elementArray.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var baseUrl = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? "/".concat(page, "/").concat(el.dataset.slug) : "".concat(config.baseProdUrl).concat(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), "/").concat(page, "/").concat(el.dataset.slug);
      window.location.assign(baseUrl);
    });
  });
};
var addNavigator = exports.addNavigator = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.prev = 6;
          _context.t0 = _context["catch"](1);
          console.error('Error sharing:', _context.t0);
        case 9:
          _context.next = 12;
          break;
        case 11:
  ...
  return function addNavigator() {
    return _ref.apply(this, arguments);
  };
}();
var checkIfFavorite = exports.checkIfFavorite = function checkIfFavorite(assetId) {
  if (JSON.parse(localStorage.getItem(config.FAVORITE_KEY))) {
    var favoriteAssetArray = JSON.parse(localStorage.getItem(config.FAVORITE_KEY));
    favoriteAssetArray.forEach(function (el) {
      if (el === assetId) {
        config.Elements.assetFavoriteIcon.forEach(function (icon) {
...
var addToFavorite = exports.addToFavorite = function addToFavorite(assetId) {
  var addToArray = true;
  var favoriteAssetArray = [];
  if (JSON.parse(localStorage.getItem(config.FAVORITE_KEY))) {
...
var removeFromFavorite = exports.removeFromFavorite = function removeFromFavorite(assetId) {
  var favoriteAssetArray = JSON.parse(localStorage.getItem(config.FAVORITE_KEY));
  var index = favoriteAssetArray.findIndex(function (el) {
    return el === assetId;
  });
  if (index !== -1) {
...
},{"./config":"config.js","./language":"language.js"}],"animation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toggleContactUsScroll = exports.toggleContactUsExpand = exports.toggleContactUsClick = exports.debounce = exports.animatePulse = exports.animateOnLoad = exports.animateMoveInRight = exports.animateMoveInLeft = exports.animateFadeIn = exports.animateCounter = exports.animateCardsFadeIn = void 0;
var config = _interopRequireWildcard(require("./config"));
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
...
var animateMoveInRight = exports.animateMoveInRight = function animateMoveInRight(element) {
...
var animateMoveInLeft = exports.animateMoveInLeft = function animateMoveInLeft(element) {
  if (window.innerWidth >= 992) {
    if (inView(element)) {
...
var animateFadeIn = exports.animateFadeIn = function animateFadeIn(element) {
  if (window.innerWidth >= 992) {
    if (inView(element)) {
...
var animatePulse = exports.animatePulse = function animatePulse(elements) {
...
var animatedElementsArray = [config.Elements.ctaBtnWhite[0], config.Elements.pricingCtaBtn];
var animateOnLoad = exports.animateOnLoad = function animateOnLoad() {
...
var toggleContactUsScroll = exports.toggleContactUsScroll = function toggleContactUsScroll(elementOne, elementTwo, elementThree, elementFour) {
...
var toggleContactUsExpand = exports.toggleContactUsExpand = function toggleContactUsExpand(elementOne, elementTwo) {
  var observer = new IntersectionObserver(function (entries) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        elementOne.classList.remove('slideUp');
...
var toggleContactUsClick = exports.toggleContactUsClick = function toggleContactUsClick(elementOne, elementTwo) {
  elementOne.classList.remove('slideUp');
  elementOne.classList.add('slideDown');
  elementOne.style.bottom = '-150px';
...
var animateCounter = exports.animateCounter = function animateCounter(element, endNum, text) {
  var currentCount = 0;
  var targetCount = endNum;
  var duration = 2000; // Animation duration in milliseconds
  var increment = targetCount / (duration / 50); // Increment value per interval
  ...
  var updateCounter = function updateCounter() {
    ...
    if (currentCount < targetCount) {
      ...
      if (text && text !== '€') {
        element.innerText = "".concat(targetCount).concat(text);
      } else if (text && text === '€') {
        element.innerText = "".concat(text).concat(targetCount);
      } else {
...
var animateCardsFadeIn = exports.animateCardsFadeIn = function animateCardsFadeIn(element) {
  var observer = new IntersectionObserver(function (element, observer) {
    var delay = 1;
    element.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        card.style.animationDelay = "".concat(delay * 0.2, "s"); // Set animation delay dynamically
        delay = ++delay;
...
var _asset = require("./asset");
var _blog = require("./blog");
var _favoriteAssets = require("./favoriteAssets");
var _mapbox = require("./mapbox");
var _language = require("./language");
var _pdf = require("./pdf");
var _webinar = require("./webinar");
var config = _interopRequireWildcard(require("./config"));
var utils = _interopRequireWildcard(require("./utils"));
var animation = _interopRequireWildcard(require("./animation"));
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
...
window.onload = function () {
  ...
  if (config.Elements.whatsappWidget) {
    var enableWidget = document.getElementById('enable-toolbar-trigger');
    var enableWidgetIcon = document.getElementById('enable-toolbar-trigger-svg');
  ...
  var projectsDdSubmenu = document.querySelectorAll('.projects-dropdown .dropdown-toggle');
  ...
  var commercialDdSubmenu = document.querySelectorAll('.commercial-dropdown .dropdown-toggle');
  ...
  config.Elements.activeNavLinks.forEach(function (link) {
  ...
  if (config.Elements.searchForm || config.Elements.modalSearchForm) {
    var searchFilterObj = JSON.parse(localStorage.getItem(config.FILTER_KEY));
    ...
    utils.clearSearchChoices(JSON.parse(localStorage.getItem(config.FILTER_KEY)), config.Elements.searchDdBtn, config.Elements.searchFilterBtn, config.Elements.searchInput);
  }
  if (config.Elements.assetFavoriteIcon) {
    config.Elements.assetFavoriteIcon.forEach(function (el) {
      var assetId = config.Elements.assetId.textContent;
      utils.checkIfFavorite(assetId);
    });
  }

  // Asset gallery main-thumbnail opacity setter
  config.Elements.assetThumbnailImgs.forEach(function (thumbnailImg) {
...
window.addEventListener('pageshow', function () {
  var href = window.location.href;
  if (href.includes("".concat(config.baseProdUrl).concat(config.EN_LANGUAGE))) {
    utils.switchLanguageIconsSrc(false);
    localStorage.setItem(config.LANGUAGE_KEY, JSON.stringify(config.EN_LANGUAGE));
    (0, _language.loadLang)(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)));
  } else {
    if (config.Elements.langDdBtn) utils.switchLanguageIconsSrc();
    localStorage.setItem(config.LANGUAGE_KEY, JSON.stringify(config.DEFAULT_LANGUAGE));
    (0, _language.loadLang)(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)));
...
if (config.Elements.navbarToggler) config.Elements.navbarToggler.addEventListener('click', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          subHref = href.substring(href.lastIndexOf('/') - 10);
          href = href.includes('en') ? href.substring(href.lastIndexOf('en') + 2) : href.substring(href.lastIndexOf('/') + 1);
...
// Currency switch
if (config.Elements.notActiveCurrencyIcon) config.Elements.notActiveCurrencyIcon.addEventListener('click', /*#__PURE__*/function () {
...
if (config.Elements.mobileNotActiveCurrencyIcon) config.Elements.mobileNotActiveCurrencyIcon.addEventListener('click', /*#__PURE__*/function () {
...
// Language switch
if (config.Elements.notActiveLangIcon) config.Elements.notActiveLangIcon.addEventListener('click', /*#__PURE__*/function () {
...
if (config.Elements.mobileNotActiveLangIcon) config.Elements.mobileNotActiveLangIcon.addEventListener('click', /*#__PURE__*/function () {
...
if (config.Elements.favoriteBtn) config.Elements.favoriteBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          (0, _favoriteAssets.getFavoriteAssets)(JSON.parse(localStorage.getItem(config.FAVORITE_KEY)));
        case 1:
        case "end":
...
if (config.Elements.mobileFavoriteBtn) config.Elements.mobileFavoriteBtn.addEventListener('click', /*#__PURE__*/function () {
...
if (config.Elements.assetFavoriteBtn) config.Elements.assetFavoriteBtn.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
if (config.Elements.mapBox && config.Elements.mapBox.dataset.long && config.Elements.mapBox.dataset.lat) {
  (0, _mapbox.displayMap)(config.Elements.mapBox.dataset.long, config.Elements.mapBox.dataset.lat, config.Elements.mapBox.dataset.title);
}

// Asset Gallery Image Switch listener
if (config.Elements.assetThumbnailImgs) config.Elements.assetThumbnailImgs.forEach(function (thumbnailImg) {
  thumbnailImg.addEventListener('click', /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(e) {
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            config.Elements.assetThumbnailImgs.forEach(function (imgOpacity) {
...
if (config.Elements.assetMainImg) config.Elements.assetMainImg.addEventListener('click', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          config.Elements.assetThumbnailImgs.forEach(function (thumbNail) {
            if (thumbNail.src === config.Elements.assetMainImg.src) {
              var markup = "<div class=\"carousel-item asset-gallery-carousel-item active align-content-center\">\n                        <img class=\"img-fluid\" src=\"".concat(thumbNail.src, "\" alt=\"Asset image\">\n                      </div> ");
              document.querySelector('.carousel-inner').insertAdjacentHTML('afterbegin', markup);
            } else {
              var _markup = "<div class=\"carousel-item asset-gallery-carousel-item align-content-center\">\n                        <img class=\"img-fluid\" src=\"".concat(thumbNail.src, "\" alt=\"Asset image\">\n                      </div>");
              document.querySelector('.carousel-inner').insertAdjacentHTML('afterbegin', _markup);
            }
          });
        case 2:
        case "end":
...
if (config.Elements.shareBtn) config.Elements.shareBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
...
if (config.Elements.shareBtnWhite) config.Elements.shareBtnWhite.forEach(function (el) {
  el.addEventListener('click', function (e) {
    utils.addNavigator();
  });
});
...
if (config.Elements.assetPdfBtn) config.Elements.assetPdfBtn.forEach(function (el) {
  el.addEventListener('click', function (e) {
    var priceArray = Array.from(config.Elements.assetPrice).map(function (price) {
      return price.innerText.trim();
    }).filter(function (value, index, self) {
      return self.indexOf(value) === index;
    });
    var descriptionArray = Array.from(config.Elements.assetDescription).map(function (description) {
      return description.innerText.trim();
    }).filter(function (value, index, self) {
      return self.indexOf(value) === index;
    });
    var amenitiesArray = Array.from(config.Elements.assetAmenities).map(function (amenity) {
      return amenity.innerText.trim();
    });
    var imagesArray = Array.from(config.Elements.assetThumbnailImgs).map(function (image) {
      return image.src;
    });
    var pdfData = {
    ...
    (0, _pdf.generatePDF)(pdfData);
  });
});

// CTA Button to Calendly
if (config.Elements.toContactUsBtn) config.Elements.toContactUsBtn.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
// To About btn
if (config.Elements.toAboutBtn) config.Elements.toAboutBtn.addEventListener('click', function (e) {
  window.location.pathname = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? '/about' : '/en/about';
});

// To blog btn
if (config.Elements.toBlogBtn) config.Elements.toBlogBtn.addEventListener('click', function (e) {
  window.location.pathname = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? '/blog' : '/en/blog';
});

// Invest guide btn
if (config.Elements.investGuideBtn) config.Elements.investGuideBtn.addEventListener('click', function (e) {
  window.location.pathname = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? '/invest' : '/en/invest';
});
if (config.Elements.blogLink) config.Elements.blogLink.addEventListener('click', function (e) {
  ...
  (0, _blog.getBlogs)(config.DEFAULT_PAGE_NUM, config.DEFAULT_BLOG_RES_PER_PAGE);
});

// Back to search results from asset page
if (config.Elements.backToSearchResultsBtn) config.Elements.backToSearchResultsBtn.addEventListener('click', function (e) {
  window.history.go(-1);
});

// Error 404 Page Button
if (config.Elements.errorBtn) config.Elements.errorBtn.addEventListener('click', function (e) {
...
if (config.Elements.searchDdBtnPrice) utils.priceInputSetter(config.Elements.priceInputMin, config.Elements.priceInputMax, false, true, config.Elements.searchDdBtnPrice);
if (config.Elements.modalPriceInputMin && config.Elements.modalPriceInputMax) utils.priceInputSetter(config.Elements.modalPriceInputMin, config.Elements.modalPriceInputMax, false, false);
if (config.Elements.searchClearFilters) config.Elements.searchClearFilters.forEach(function (el) {
  el.addEventListener('click', function (e) {
    utils.clearSearchChoices(JSON.parse(localStorage.getItem(config.FILTER_KEY)), config.Elements.searchDdBtn, config.Elements.searchFilterBtn, config.Elements.searchInput);
  });
});
...
if (config.Elements.priceInput) config.Elements.priceInput.forEach(function (el) {
  el.addEventListener('input', function (e) {
    var euroSymbol = JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪';
...
// Search Form
if (config.Elements.searchForm) config.Elements.searchForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var searchFilterObj = utils.getFormData(config.Elements.searchFilterBtnCity, config.Elements.searchFilterBtnRooms, config.Elements.searchFilterBtnOceanView, config.Elements.searchFilterBtnProject, JSON.parse(localStorage.getItem(config.CURRENCY_KEY)), config.Elements.priceInputMin, config.Elements.priceInputMax, config.Elements.searchInputId, config.Elements.searchInputName);
  localStorage.setItem(config.FILTER_KEY, JSON.stringify(searchFilterObj));
...
// Modal Search Form
if (config.Elements.modalSearchForm) config.Elements.modalSearchForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var searchFilterObj = utils.getFormData(config.Elements.modalSearchFilterBtnCity, config.Elements.modalSearchFilterBtnRooms, config.Elements.modalSearchFilterBtnOceanView, config.Elements.modalSearchFilterBtnProject, JSON.parse(localStorage.getItem(config.CURRENCY_KEY)), config.Elements.modalPriceInputMin, config.Elements.modalPriceInputMax, config.Elements.modalSearchInputId, config.Elements.modalSearchInputName);
  localStorage.setItem(config.FILTER_KEY, JSON.stringify(searchFilterObj));
  localStorage.setItem(config.SORT_KEY, JSON.stringify(config.DEFAULT_SORT));
  localStorage.setItem(config.TYPE_KEY, JSON.stringify(config.DEFAULT_TYPE));
  localStorage.setItem(config.PAGE_NUMBER_KEY, JSON.stringify(config.DEFAULT_PAGE_NUM));
...
if (config.Elements.searchResultsFilters) config.Elements.searchResultsFilters.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
if (config.Elements.searchResultsFiltersDdBtn) config.Elements.searchResultsFiltersDdBtn.addEventListener('click', function (e) {
  config.Elements.searchResultsFilters.forEach(function (el) {
    if (el.dataset.sort === JSON.parse(localStorage.getItem(config.SORT_KEY)) && parseInt(el.dataset.type) === parseInt(JSON.parse(localStorage.getItem(config.TYPE_KEY)))) {
      el.classList.add('search-results-filters-active');
    }
  });
});
if (config.Elements.paginationPageBtn) config.Elements.paginationPageBtn.forEach(function (el) {
  var href = window.location.href;
  ...
  el.addEventListener('click', function (e) {
    ...
    if (href.includes("".concat(config.baseProdUrl, "asset/search-results")) || href.includes("".concat(config.baseProdUrl).concat(config.EN_LANGUAGE, "/asset/search-results"))) {
      ...
      (0, _blog.getBlogs)(JSON.parse(localStorage.getItem(config.PAGE_NUMBER_KEY)), config.DEFAULT_BLOG_RES_PER_PAGE);
    }
  });
});
if (config.Elements.paginationPrevPageBtn && config.Elements.paginationNextPageBtn) {
  ...
  if (JSON.parse(localStorage.getItem(config.PAGE_NUMBER_KEY)) === config.DEFAULT_PAGE_NUM) {
    ...
    config.Elements.paginationNextPageBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    config.Elements.paginationPrevPageBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    config.Elements.paginationIconBtn.forEach(function (el) {
...
if (config.Elements.contactUsForm) config.Elements.contactUsForm.forEach(function (el) {
...
if (config.Elements.contactUsPhoneInput) config.Elements.contactUsPhoneInput.addEventListener('input', function () {
...
if (config.Elements.contactUsEmailInput) config.Elements.contactUsEmailInput.addEventListener('input', function () {
...
if (config.Elements.calendlyAgentsChoices) config.Elements.calendlyAgentsChoices.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
if (config.Elements.contactUsCloseBtnFixed) config.Elements.contactUsCloseBtnFixed.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
if (config.Elements.contactUsExpandBtn) config.Elements.contactUsExpandBtn.forEach(function (el) {
  el.addEventListener('click', function (e) {
    if (window.innerWidth >= 768) {
...
// Webinar
if (config.Elements.webinarForm) config.Elements.webinarForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var userName = config.Elements.webinarFormInputName.value;
  var userPhone = config.Elements.webinarFormInputPhone.value;
  var userEmail = config.Elements.webinarFormInputEmail.value;
  var userIsSubscribed = config.Elements.webinarFormCheck.checked;
  (0, _webinar.webinarRegistration)(userName, userPhone, userEmail, userIsSubscribed);
});

// ***** Animations *****

// Contact Us fixed animation
if (config.Elements.contactUsContainerFixed) animation.toggleContactUsScroll(config.Elements.contactUsContainerFixed, config.Elements.contactUsMobileContainerFixed, config.Elements.footerContainer, config.Elements.contactUsExpandBtnContainer);
if (config.Elements.contactUsExpandBtnContainer) animation.toggleContactUsExpand(config.Elements.contactUsExpandBtnContainer, config.Elements.footerCopyContainer);
...
if (config.Elements.aeProjectAreaNumber) animation.animateCounter(config.Elements.aeProjectAreaNumber, 27955, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
if (config.Elements.aeProjectGreenAreaNumber) animation.animateCounter(config.Elements.aeProjectGreenAreaNumber, 5200, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Atlantis Barcode
...
if (config.Elements.abProjectAreaNumber) animation.animateCounter(config.Elements.abProjectAreaNumber, 9634, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Atlantis Barcode
...
if (config.Elements.azimuthProjectAreaNumber) animation.animateCounter(config.Elements.azimuthProjectAreaNumber, 68000, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Camelot
if (config.Elements.camelotProjectPriceNumber) animation.animateCounter(config.Elements.camelotProjectPriceNumber, new Intl.NumberFormat().format(2800000), '€');
...
if (config.Elements.camelotProjectAreaNumber) animation.animateCounter(config.Elements.camelotProjectAreaNumber, 3390, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
if (config.Elements.camelotProjectBuiltAreaNumber) animation.animateCounter(config.Elements.camelotProjectBuiltAreaNumber, 6660, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Sofia B5
if (config.Elements.sofiab5ProjectPriceNumber) animation.animateCounter(config.Elements.sofiab5ProjectPriceNumber, new Intl.NumberFormat().format(2800), "\u20AC/\u33A1");
...
if (config.Elements.sofiab5ProjectBuiltAreaNumber) animation.animateCounter(config.Elements.sofiab5ProjectBuiltAreaNumber, 267, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Samokov
if (config.Elements.samokovProjectAreaNumber) animation.animateCounter(config.Elements.samokovProjectAreaNumber, 93000, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
...
if (config.Elements.hotAssetsContainer || config.Elements.projectAssetsContainer) {
  ...
  config.Elements.assetCards.forEach(function (card) {
    card.style.opacity = 1;
  });
}
},{"./asset":"asset.js","./blog":"blog.js","./favoriteAssets":"favoriteAssets.js","./mapbox":"mapbox.js","./language":"language.js","./pdf":"pdf.js","./webinar":"webinar.js","./config":"config.js","./utils":"utils.js","./animation":"animation.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
