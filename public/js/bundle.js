...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"asset.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.location.href = "/asset/search-results?sort=".concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber);
          }
          _context.next = 11;
          break;
        case 8:
...
exports.nisIconSrc = exports.nisIconAlt = exports.euroIconSrc = exports.euroIconAlt = exports.TYPE_KEY = exports.SORT_KEY = exports.RES_PER_PAGE_KEY = exports.PAGE_NUMBER_KEY = exports.NIS_CURRENCY = exports.FILTER_KEY = exports.Elements = exports.DEFAULT_TYPE = exports.DEFAULT_SORT = exports.DEFAULT_RES_PER_PAGE = exports.DEFAULT_PAGE_NUM = exports.DEFAULT_FILTER = exports.DEFAULT_CURRENCY = exports.CURRENCY_KEY = void 0;
...
var euroIconAlt = exports.euroIconAlt = 'Euro currency icon';
var nisIconSrc = exports.nisIconSrc = '/img/icons/nis.svg';
var nisIconAlt = exports.nisIconAlt = 'Nis currency icon';
...
exports.switchSearchPriceCurrencyHtmlOnLoad = exports.switchCurrencyIconsSrcOnLoad = exports.switchCurrencyIconsSrc = exports.switchCurrency = exports.switchAssetPriceCurrency = exports.reverseString = exports.priceInputSetter = exports.inView = exports.getPageBySlug = exports.getFormData = exports.ddBtnTextSetter = exports.clearSearchChoices = exports.clearDuplicates = exports.btnAddActive = exports.animatePulse = exports.addNavigator = void 0;
...
var switchCurrencyIconsSrcOnLoad = exports.switchCurrencyIconsSrcOnLoad = function switchCurrencyIconsSrcOnLoad() {
  var isEuro = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  if (isEuro) {
    var markupLaptop = "<img class=\"navbar-currency-icon navbar-active-currency-icon\" src=\"".concat(config.euroIconSrc, "\" alt=\"").concat(config.euroIconAlt, "\">");
    document.querySelector('.currency-ddbtn').insertAdjacentHTML('afterbegin', markupLaptop);
    var markupMobile = "<img class=\" navbar-currency-icon mobile-navbar-active-currency-icon\" src=\"".concat(config.euroIconSrc, "\" alt=\"").concat(config.euroIconAlt, "\">");
    ...
    var _markupLaptop = "<img class=\"navbar-currency-icon navbar-active-currency-icon\" src=\"".concat(config.nisIconSrc, "\" alt=\"").concat(config.nisIconAlt, "\">");
    document.querySelector('.currency-ddbtn').insertAdjacentHTML('afterbegin', _markupLaptop);
    var _markupMobile = "<img class=\" navbar-currency-icon mobile-navbar-active-currency-icon\" src=\"".concat(config.nisIconSrc, "\" alt=\"").concat(config.nisIconAlt, "\">");
    document.querySelector('.mobile-currency-ddbtn').insertAdjacentHTML('afterbegin', _markupMobile);
...
var switchCurrencyIconsSrc = exports.switchCurrencyIconsSrc = function switchCurrencyIconsSrc() {
  var isEuro = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  var activeCurrencyIcon = document.querySelector('.navbar-active-currency-icon');
  var mobileActiveCurrencyIcon = document.querySelector('.mobile-navbar-active-currency-icon');
  if (isEuro) {
...
var getFormData = exports.getFormData = function getFormData(cityFilter, roomsFilter, typeFilet, projectFilter, oceanViewFilter, priceMinInput, priceMaxInput, idInput, nameInput) {
  var searchFilterObj = {
    city: [],
    rooms: [],
    type: [],
...
var btnAddActive = exports.btnAddActive = function btnAddActive(searchFilterObj, filterBtn, type) {
  ...
  filterBtn.forEach(function (el) {
    ...
    if (type === 'type') {
      var _iterator4 = _createForOfIteratorHelper(searchFilterObj.type),
        _step4;
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          var _type = _step4.value;
          if (el.innerText === _type) {
            el.classList.add('active');
          }
          if (notModal) {
            ddBtnTextSetter(ddBtn, filterBtn, true);
    ...
    if (type === 'project') {
      var _iterator5 = _createForOfIteratorHelper(searchFilterObj.project),
        _step5;
      try {
  ...
  if (!onLoad) {
    document.querySelector('.content-col').addEventListener('click', function (e) {
      ...
      if (inputMin.value && inputMax.value) {
        ...
        inputMax.value = currencySymbol + inputMax.value;
        if (notModal) {
          var _priceText = document.createTextNode(' (' + inputMin.value + ' - ' + inputMax.value + ')');
          ddBtn.innerText = ddBtn.dataset.original;
        ...
        inputMin.value = currencySymbol + inputMin.value;
        if (notModal) {
          var _priceText2 = document.createTextNode(' (' + inputMin.value + ' - ' + inputMax.value + ')');
          ddBtn.innerText = ddBtn.dataset.original;
          ddBtn.appendChild(_priceText2);
        }
      } else if (!inputMin.value && !inputMax.value) {
        if (notModal) {
          var _priceText3 = document.createTextNode(' (' + currencySymbol + '0' + ' - ' + currencySymbol + '1,000,000' + ')');
          ddBtn.innerText = ddBtn.dataset.original;
    ...
    if (inputMin.value && inputMax.value) {
      ...
      inputMax.value = currencySymbol + inputMax.value;
      if (notModal) {
        var _priceText4 = document.createTextNode(' (' + inputMin.value + ' - ' + inputMax.value + ')');
        ddBtn.innerText = ddBtn.dataset.original;
      ...
      inputMin.value = currencySymbol + inputMin.value;
      if (notModal) {
        var _priceText5 = document.createTextNode(' (' + inputMin.value + ' - ' + inputMax.value + ')');
        ddBtn.innerText = ddBtn.dataset.original;
        ddBtn.appendChild(_priceText5);
      }
    } else if (!inputMin.value && !inputMax.value) {
      if (notModal) {
        var _priceText6 = document.createTextNode(' (' + currencySymbol + '0' + ' - ' + currencySymbol + '1,000,000' + ')');
        ddBtn.innerText = ddBtn.dataset.original;
...
var clearSearchChoices = exports.clearSearchChoices = function clearSearchChoices(searchFilterObj, ddBtn, filterBtn, input) {
  ...
  ddBtn.forEach(function (el) {
    if (!el.innerText.includes('מחיר')) {
      ...
      el.innerText = el.dataset.original + " (".concat(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪', "0 - ").concat(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)) === 'euro' ? '€' : '₪', "1,000,000)");
    }
  });
  filterBtn.forEach(function (el) {
...
var clearDuplicates = exports.clearDuplicates = function clearDuplicates(searchFilterObj) {
  ...
  var _iterator6 = _createForOfIteratorHelper(filterSet),
    _step6;
  try {
...
var getPageBySlug = exports.getPageBySlug = function getPageBySlug(elementArray, page) {
  elementArray.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var baseUrl = "/".concat(page, "/").concat(el.dataset.slug);
      window.location.assign(baseUrl);
    });
  });
};
var inView = exports.inView = function inView(element) {
  if (element) {
...
if (config.Elements.shareBtn) config.Elements.shareBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
...
if (config.Elements.toCalendlyBtn) config.Elements.toCalendlyBtn.forEach(function (el) {
  el.addEventListener('click', function (e) {
...
if (config.Elements.searchForm) config.Elements.searchForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var searchFilterObj = utils.getFormData(config.Elements.searchFilterBtnCity, config.Elements.searchFilterBtnRooms, config.Elements.searchFilterBtnType, config.Elements.searchFilterBtnProject, config.Elements.searchFilterBtnOceanView, config.Elements.priceInputMin, config.Elements.priceInputMax, config.Elements.searchInputId, config.Elements.searchInputName);
  localStorage.setItem(config.FILTER_KEY, JSON.stringify(searchFilterObj));
...
},{"./asset":"asset.js","./mapbox":"mapbox.js","./config":"config.js","./utils":"utils.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
