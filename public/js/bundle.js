      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.location.href = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? "/asset/search-results?sort=".concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber) : "".concat(config.baseDevUrl).concat(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), "/asset/search-results?sort=").concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber);
          }
          _context.next = 11;
          break;
        case 8:
...
var switchLanguage = exports.switchLanguage = function switchLanguage(langIconSrc, href) {
  if (langIconSrc.includes(config.heIconSrc)) {
    ...
    href = modifyUrl(href, config.baseDevUrl);
...
var getPageBySlug = exports.getPageBySlug = function getPageBySlug(elementArray, page) {
  elementArray.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var baseUrl = JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? "/".concat(page, "/").concat(el.dataset.slug) : "".concat(config.baseDevUrl).concat(JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)), "/").concat(page, "/").concat(el.dataset.slug);
...
exports.handleScroll = exports.debounce = exports.animatePulse = exports.animateMoveInRight = exports.animateMoveInLeft = exports.animateFadeIn = exports.animateCounter = void 0;
var config = _interopRequireWildcard(require("./config"));
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function (e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
...
var handleScroll = exports.handleScroll = function handleScroll() {
...
window.onload = function () {
  ...
  if (config.Elements.whatsappWidget) {
    ...
    if (_href.includes('asset') || _href.includes('project')) {
  ...
  var dropdownSubmenus = document.querySelectorAll('.projects-dropdown .dropdown-toggle');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          subHref = href.substring(href.lastIndexOf('/') - 7);
          href = href.includes('en') ? href.substring(href.lastIndexOf('en') + 2) : href.substring(href.lastIndexOf('/') + 1);
...
if (config.Elements.contactUsForm) config.Elements.contactUsForm.addEventListener('submit', function (event) {
...
if (config.Elements.al6ProjectAreaNumber) animation.animateCounter(config.Elements.al6ProjectAreaNumber, 19063, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
if (config.Elements.al6ProjectGreenAreaNumber) animation.animateCounter(config.Elements.al6ProjectGreenAreaNumber, 16187, JSON.parse(localStorage.getItem(config.LANGUAGE_KEY)) === config.DEFAULT_LANGUAGE ? 'מ"ר' : "\u33A1");
// Fade in animation
...
},{"./asset":"asset.js","./favoriteAssets":"favoriteAssets.js","./mapbox":"mapbox.js","./language":"language.js","./config":"config.js","./utils":"utils.js","./animation":"animation.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
