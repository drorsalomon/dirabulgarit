      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.location.href = "/asset/search-results?q=".concat(encodeURIComponent(JSON.stringify(filter)), "&sort=").concat(sort, "&type=").concat(type, "&totalAssets=").concat(totalAssets, "&totalPages=").concat(encodeURIComponent(JSON.stringify(totalPages)), "&pageNumber=").concat(_pageNumber);
          }
          _context.next = 11;
          break;
        case 8:
...
},{}],"currency.js":[function(require,module,exports) {
"use strict";
...
var getCurrency = exports.getCurrency = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(activeCurrency, notActiveCurrency) {
    var res, currency, currencySymbol;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/".concat(activeCurrency),
            data: {
              activeCurrency: activeCurrency,
              notActiveCurrency: notActiveCurrency
            }
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            ...
            currencySymbol = currency.active === 'euro' ? '€' : '₪';
  ...
  return function getCurrency(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./config":"config.js"}],"utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.switchCurrency = exports.reverseString = exports.priceInputSetter = exports.inView = exports.getPageBySlug = exports.getFormData = exports.ddBtnTextSetter = exports.clearSearchChoices = exports.clearDuplicates = exports.btnAddActive = exports.animatePulse = exports.addNavigator = void 0;
var config = _interopRequireWildcard(require("./config"));
...
var switchCurrencyHtml = function switchCurrencyHtml(ddBtn, priceInput) {
...
var switchCurrency = exports.switchCurrency = function switchCurrency(activeCur, notActiveCur) {
  var tempSrc = activeCur.src;
  ...
  if (activeCur.src.includes(config.DEFAULT_CURRENCY)) {
    ...
    (0, _currency.getCurrency)(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)), config.NIS_CURRENCY);
    ...
    (0, _currency.getCurrency)(JSON.parse(localStorage.getItem(config.CURRENCY_KEY)), config.DEFAULT_CURRENCY);
...
var getPageBySlug = exports.getPageBySlug = function getPageBySlug(elementArray, page) {
  elementArray.forEach(function (el) {
    el.addEventListener('click', function (e) {
      window.location.pathname = "/".concat(page, "/").concat(el.dataset.slug);
    });
  });
};
...
},{"./config":"config.js","./currency":"currency.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (config.Elements.shareBtnWhite) config.Elements.shareBtnWhite.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
