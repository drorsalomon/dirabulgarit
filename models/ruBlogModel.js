...
const ruBlogSchema = mongoose.Schema({
  id: {
    type: Number,
  ...
  midImgSrc: {
    type: String,
    required: [true, 'A blog must have an mid image src!'],
  },
  midImgAlt: {
    type: String,
    required: [true, 'A blog must have an mid image alt!'],
  },
  ...
  sectionSixteenTitle: String,
  sectionSixteenTexts: [String],
  sectionSeventeenTitle: String,
  sectionSeventeenTexts: [String],
  sectionEighteenTitle: String,
  sectionEighteenTexts: [String],
  sectionNineteenTitle: String,
  sectionNineteenTexts: [String],
  sectionTwentyTitle: String,
  sectionTwentyTexts: [String],
  sectionTwentyOneTitle: String,
  sectionTwentyOneTexts: [String],
  sectionTwentyTwoTitle: String,
  sectionTwentyTwoTexts: [String],
  sectionTwentyThreeTitle: String,
  sectionTwentyThreeTexts: [String],
  listOne: {
    listOneTitle: String,
    listOneTexts: [String],
  },
...
const ruBlog = mongoose.model('ruBlog', ruBlogSchema);

module.exports = ruBlog;
